...
import * as domainExtensions from './0003-domain-extensions.js';
...
export const MIGRATIONS: readonly Migration[] = [
  ...
  {
    version: domainExtensions.VERSION,
    description: domainExtensions.DESCRIPTION,
    up: domainExtensions.up,
  },
];
